public abstract class Bil {
    ...
    //Abstract metode, som hver class der nedarver skal have.
    public abstract double beregnGrønAfgift();

    //Override metode til at printe bilens oplysninger ud
    @Override
    public String toString() {
        return "Bil{" + "regNr='" + regNr + '\'' + ", mærke='" + mærke + '\'' + ", model='" + model + '\'' + ", årgang=" + årgang + ", antalDøre=" + antalDøre + '}';
    }
}
